...
struct Lemma {
 ...
 Lemma(long int lemma_id_, std::string lemma_form_ = "", std::string morph_replace_ = "", std::string second_velar_ = "",
 std::string poss_doublet_ = "", short int loan_place_ = 0, short int long_adj_ = 0, bool non_assim_ = false, std::string eng_trans_ = "", std::string pre_jot_ = "",
 std::string etym_disc_ = "",  bool bad_etym_ = false,
 std::string loan_source_ = "", std::string conj_type_ = "", short int noun_verb_ = 0)
        : lemma_id{ lemma_id_ }, lemma_form{ lemma_form_ }, morph_replace{ morph_replace_ }, second_velar{ second_velar_ }, poss_doublet { poss_doublet_ },
        loan_place { loan_place_}, long_adj { long_adj_ }, non_assim { non_assim_ }, eng_trans { eng_trans_ }, pre_jot { pre_jot_ },
        etym_disc { etym_disc_ }, bad_etym { bad_etym_ }, loan_source { loan_source_ }, conj_type { conj_type_ }, noun_verb {noun_verb_}
    {
