...
{58916,"pri","","","",0,0,false,"","","Following the ESSY and Derksen 2008 jь- is used for all inherited word-initial and post-vocalic *i, but this means that OCS вънити is still /vъniti/ because 1. here the vowel comes from *ei-, and 2. it never went /i/>/jь/ because the /n/ was always in the way. thus прити < /prijьti/ but  вънити /vъniti/. (Cf. Pol. wejść < vъjьsti (analogous to вести) which has obviously been reformed after loss of /n/, compared to archaic wniść).",false,"","jьti",1},
...
{58936,"","","","",0,0,false,"","","Following the ESSY and Derksen 2008 jь- is used for all inherited word-initial and post-vocalic *i (except pronouns, cf. Cz jim, jich) , but this means that OCS вънити is still /vъniti/ because 1. here the vowel comes from *ei-, and 2. it never went /i/>/jь/ because the /n/ was always in the way. thus прити < /prijьti/ but  вънити /vъniti/. (Cf. Pol. wejść < vъjьsti (analogous to вести) which has obviously been reformed after loss of /n/, compared to archaic wniść).",false,"","jьti",1},
...
{66254,"zemjьn","","","",0,0,false,"","","There are no attestations of **земл҄ьнъ, but dict. p.236 does list земл҄ьскъ, and given that the -j- was part of the stem of *zemĺǞ in CS times, and that the dialects underlying most OCS manuscripts probably had lost epenthetic /ĺ/ even though they did often remember to write it, I can't see any justification for reconstructing a *zemьnъ, so I will use *zemĺьnъ",false,"","adj_hard",2},
...
{69084,"my etymology is: root *tretьj- + *ika + instrument","tretьjikojǫ","tretьjicejǫ","",0,0,false,"for a third time","","",false,"","",0},
